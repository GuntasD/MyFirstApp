...
package com.guntasdhanjal.myfirstapp;
 ...
 * @author Shai Almog
 */
public class MyFirstAppStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "MyFirstApp";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new MyFirstAppStub());
    }
